...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--enable-shared --disable-static --enable-memalign-hack --toolchain=msvc --enable-gpl --enable-libx264 --enable-libfdk_aac --enable-nonfree --extra-cflags=-I./add_lib/include --extra-ldflags='-L.\add_lib\lib' --extra-ldflags='-LIBPATH:.\add_lib\lib' --extra-ldflags='-LIBPATH:C:\PROGRA~2\MICROS~1.0\VC\lib'
prefix=/usr/local
...
CC_IDENT=用于 x86 的 Microsoft (R) C/C++ 优化编译器 19.00.24215.1 版
ARCH=x86
INTRINSICS=none
CC=cl
CXX=g++
...
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -D_WIN32_WINNT=0x0502
CFLAGS= -nologo -D_USE_MATH_DEFINES -D_CRT_SECURE_NO_WARNINGS -D_CRT_NONSTDC_NO_WARNINGS -I./add_lib/include   -Z7 -W4 -wd4244 -wd4127 -wd4018 -wd4389 -wd4146 -wd4057 -wd4204 -wd4706 -wd4305 -wd4152 -wd4324 -we4013 -wd4100 -wd4214 -wd4307 -wd4273 -wd4554 -wd4701 -O2   -Oy- -d2SSAOptimizer-
CXXFLAGS=  -D__STDC_CONSTANT_MACROS -std=c++98
OBJCFLAGS= -nologo -D_USE_MATH_DEFINES -D_CRT_SECURE_NO_WARNINGS -D_CRT_NONSTDC_NO_WARNINGS 
ASFLAGS= -nologo -D_USE_MATH_DEFINES -D_CRT_SECURE_NO_WARNINGS -D_CRT_NONSTDC_NO_WARNINGS -I./add_lib/include -Z7
AS_C=-c
AS_O=-Fo$@
OBJCC_C=-c
OBJCC_E=-E -o $@
...
DEPWINDRES=cl
DOXYGEN=doxygen
LDFLAGS= -LIBPATH:".\add_lib\lib" -LIBPATH:C:\PROGRA~2\MICROS~1.0\VC\lib -nologo -LARGEADDRESSAWARE -debug
LDEXEFLAGS=
LDLIBFLAGS=
...
HOSTCC=cl
HOSTLD=cl
HOSTCFLAGS= -nologo -D_USE_MATH_DEFINES -D_CRT_SECURE_NO_WARNINGS -D_CRT_NONSTDC_NO_WARNINGS  -W4 -wd4244 -wd4127 -wd4018 -wd4389 -wd4146 -wd4057 -wd4204 -wd4706 -wd4305 -wd4152 -wd4324 -we4013 -wd4100 -wd4214 -wd4307 -wd4273 -wd4554 -wd4701 -O3
...
EXTRALIBS=ws2_32.lib vfw32.lib user32.lib gdi32.lib psapi.lib ole32.lib strmiids.lib uuid.lib oleaut32.lib shlwapi.lib  secur32.lib libx264.lib fdk-aac.lib psapi.lib advapi32.lib shell32.lib 
COMPAT_OBJS=
EXEOBJS=
INSTALL=install
LIBTARGET=
