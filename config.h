...
#define FFMPEG_CONFIGURATION "--enable-shared --disable-static --enable-memalign-hack --toolchain=msvc --enable-gpl --enable-libx264 --enable-libfdk_aac --enable-nonfree --extra-cflags=-I./add_lib/include --extra-ldflags='-L.\\add_lib\\lib' --extra-ldflags='-LIBPATH:.\\add_lib\\lib' --extra-ldflags='-LIBPATH:C:\\PROGRA~2\\MICROS~1.0\\VC\\lib'"
#define FFMPEG_LICENSE "nonfree and unredistributable"
#define CONFIG_THIS_YEAR 2016
#define FFMPEG_DATADIR "/usr/local/share/ffmpeg"
#define AVCONV_DATADIR "/usr/local/share/ffmpeg"
#define CC_IDENT "用于 x86 的 Microsoft (R) C/C++ 优化编译器 19.00.24215.1 版"
